...
function writeIdentityDocs(targetRoot, projectName) {
  ...
  writeRelative(
    ...
    markdown([
      "# AGENTS.md",
      "",
      "This is a code-first Codex project. Read `instructions.md`, the root README, the always-read",
      "central truth in `docs/project.md`, and optional `docs/project-context.md`, then inspect",
      "task-relevant source and tests.",
      "",
      ...
      "work may use one bounded, overwritten project-context file for the current goal and slice; never",
      "create per-slice files or archives. Normal work should produce implementation and tests.",
      "",
      "Fix root causes at the owning boundary, keep secrets and machine-local state out of Git, run focused",
      "checks while iterating, and run `mise exec --locked -- pnpm verify` once before handoff.",
    ]),
  );
  writeRelative(
    targetRoot,
    ...
    markdown([
      ...
      "",
      "Read [Project Instructions](instructions.md) and the always-read central truth in the",
      "[Project Manifest](docs/project.md). Read `docs/project-context.md` when complex multi-session",
      "work has created it. Keep normal planning and status in the conversation.",
      "",
  ...
  writeRelative(
    ...
    markdown([
      ...
      "`pnpm setup` materializes and smoke-tests that vector space; unrelated verification and pre-push",
      "remain read-only and do not rebuild it.",
      "",
      "## Workflow",
      "",
      ...
      "2. Keep normal preflight plans, progress, reviews, and handoffs in the conversation.",
  ...
  writeRelative(
    ...
    markdown([
      "# Project Manifest",
      "",
      "This is the always-read, concise central source of truth for " + displayName + ".",
      "",
      "## Definition",
      "",
      ...
      "  remain outside every product unit. Generation does not copy vector state; `pnpm setup` creates",
      "  and validates this project's own vector space before initialization is complete.",
      ...
      "reviews, and implementation detail out. Optional project context cannot override this manifest.",
    ]),
  );
}
