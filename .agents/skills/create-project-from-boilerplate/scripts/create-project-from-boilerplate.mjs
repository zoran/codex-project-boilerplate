...
function writeIdentityDocs(targetRoot, projectName) {
  ...
  writeRelative(
    ...
    markdown([
      ...
      "  existing lock. Ignored turn-boundary index writes do not satisfy `pnpm goal:new`;",
      "  `context:check`, verification, goal publication checks, and pre-push remain strictly read-only.",
